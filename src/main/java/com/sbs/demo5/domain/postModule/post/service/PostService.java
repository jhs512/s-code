package com.sbs.demo5.domain.postModule.post.service;

import com.sbs.demo5.domain.baseModule.document.service.DocumentService;
import com.sbs.demo5.domain.baseModule.document.standard.DocumentHavingSortableTags;
...
import com.sbs.demo5.domain.postModule.post.repository.PostRepository;
import com.sbs.demo5.domain.postModule.postKeyword.entity.PostKeyword;
import com.sbs.demo5.domain.postModule.postKeyword.repository.PostKeywordRepository;
...
public class PostService {
    ...
    public RsData<GenFile> saveAttachmentFile(Post post, String attachmentFile, long fileNo) {
        GenFile genFile = genFileService.save(post.getModelName(), post.getId(), "globalModule", "attachment", fileNo, attachmentFile);
    ...
    public void removeAttachmentFile(Post post, long fileNo) {
        genFileService.remove(post.getModelName(), post.getId(), "globalModule", "attachment", fileNo);
    }
