package com.ll.domain.articleModule.article.service;
...
import com.ll.domain.articleModule.article.repository.ArticleRepository;
...
public class ArticleService {
    ...
    public RsData<GenFile> saveAttachmentFile(Article article, String attachmentFile, long fileNo) {
        GenFile genFile = genFileService.save(article.getModelName(), article.getId(), "global", "attachment", fileNo, attachmentFile);
    ...
    public void removeAttachmentFile(Article article, long fileNo) {
        genFileService.remove(article.getModelName(), article.getId(), "global", "attachment", fileNo);
    }
