...
import static com.ll.domain.bookModule.book.entity.QBook.book;

@RequiredArgsConstructor
public class BookRepositoryImpl implements com.ll.domain.bookModule.book.repository.BookRepositoryCustom {
