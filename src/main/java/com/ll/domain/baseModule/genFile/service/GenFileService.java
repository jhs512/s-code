package com.ll.domain.baseModule.genFile.service;

import com.ll.domain.baseModule.genFile.entity.GenFile;
import com.ll.domain.baseModule.genFile.repository.GenFileRepository;
...
public class GenFileService {
    ...
    public GenFile saveTempFile(Member actor, MultipartFile file) {
        return save("temp_" + actor.getModelName(), actor.getId(), "global", "editorUpload", 0, file);
    }
